...
public class NumberToWord 
{
	 ...
	 private NumberToWord() {}
	  ...
	  public static String convert(long number) {
	    ...
	    case 0:
	      ...
	      break;
	    case 1 :
	      tradBillions = convertBelowThousand(billions)
	      + " billion ";
	      break;
	    default :
	      tradBillions = convertBelowThousand(billions)
	    ...
	    case 0:
	      ...
	      break;
	    case 1 :
	      tradMillions = convertBelowThousand(millions)
	         + " million ";
	      break;
	    default :
	      tradMillions = convertBelowThousand(millions)
	    ...
	    case 1 :
	      ...
	      break;
	    default :
	      tradHundredThousands = convertBelowThousand(hundredThousands)
	         + " thousand ";
	    }
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("100 =  " + NumberToWord.convert(100));
